...
// console.log("mohamed ali")
// let ali = "legend" //(let) markasta oo aan isticmaalno let javascri waxan ushegayaa inaan samynyno variable.
// console.log(ali)
// ali = "iconic"
// console.log(ali)
// const ahmed = "moalimow"//(const) waxay la mid tahay led lkn waxay ku kala duwan yihiin ma badali kartid value.
// console.log(ahmed)
// // DATA TYPES
// let nAme = "Firkcamp is a coding bootcamp" //string
// let Age = 30 //number
// let hungry = false //boolean
...
// // I am a cohort 3 student at fikrcamp

// console.log("I am a " + cohort + " student at " + name)
...
// const age = 26
// if(age < 50){
//     console.log("i am still a young ")
// }
// //elseif
// let Name = "abdi"
...
//     console.log("Hi Abdi")   
// }else{
//     console.log("Yout not Ali or Mo")
// }
// //else
// let AGE = 10
...
// let g = 6
// if (k > g){
//     console.log(`${k} is greater then ${g}`)
// }
// //logicaloperatorexample
// let hascar = true
// let haslicense = false
// let agE = 21
// if(agE > 18 && haslicense === false && hascar === true){
